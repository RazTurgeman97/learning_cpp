...
class StudentRecords{
 // we didn't overload the constructor because we don't need to initialize anything when we create StudentRecords object, so the default constructor will do.
private:
